...
import '../../../Const.dart';
import '../../data/controllers/HorseController.dart';

class PreviousReport extends StatefulWidget {
  const PreviousReport({
    Key? key,
  }) : super(key: key);

  @override
  State<PreviousReport> createState() => _PreviousReportState();
}

class _PreviousReportState extends State<PreviousReport> {
  @override
